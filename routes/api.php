...
use App\Http\Controllers\SerieEpisodeController;
use App\Http\Controllers\SerieSeasonController;
...
Route::put('/series/{id}', [SerieController::class, 'update'])->middleware(['auth:sanctum']);
Route::delete('/series/{id}', [SerieController::class, 'delete'])->middleware(['auth:sanctum']);

Route::get('series/{id}/seasons', [SerieSeasonController::class, 'index'])->middleware(['auth:sanctum']);
Route::get('series/{id}/episodes', [SerieEpisodeController::class, 'index'])->middleware(['auth:sanctum']);
...
Route::put('/seasons/{id}', [SeasonController::class, 'update'])->middleware(['auth:sanctum']);
